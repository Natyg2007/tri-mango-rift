const canvas = document.querySelector("#circuitGame");
const ctx = canvas.getContext("2d");
const root = document.querySelector("#circuitRoot");
const phaseNameNode = document.querySelector("#circuitPhaseName");
const mangoCountNode = document.querySelector("#circuitMangoCount");
const scoreNode = document.querySelector("#circuitScore");
const arenaNameNode = document.querySelector("#circuitArenaName");
const timerNode = document.querySelector("#circuitTimer");
const statusNode = document.querySelector("#circuitStatus");
const startButton = document.querySelector("#circuitStartButton");
const resetButton = document.querySelector("#circuitResetButton");
const phaseButtons = [...document.querySelectorAll(".circuit-phase-button")];
...
function returnToInfo() {
  ...
  keys.clear();
  hideStatus();
  document.querySelector("#second-sample").scrollIntoView({ behavior: "smooth", block: "start" });
}
